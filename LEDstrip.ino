      ...
      if(((millis()-blob1.timeColl)>30)&&((millis()-blob2.timeColl)>30)){
        if (depOrArrv(blob1,blob2)==0){
          if (abs(blob1.x-blob2.x)<=3){
            ...
            //          if ((blob1.v*blob2.v)<0){
            //            blob1.v=random(100,300)*findSign(blob1.v)*-1/100;
            //          }
            //          else{
            //            blob1.v=random(100,100*blob1.v)*findSign(blob1.v)/100;
            //          }
            //          blob2.v=blob2.v-(blob1.v-tempVol);
            //


            //          blob2.color[0]=(blob2.color[0]+blob1.color[0]*0.1f)/1.1f;
            //          blob2.color[1]=(blob2.color[1]+blob1.color[1]*0.1f)/1.1f;
            //          blob2.color[2]=(blob2.color[2]+blob1.color[2]*0.1f)/1.1f;
            //          blob1.color[0]=(blob1.color[0]+blob2.color[0]*0.1f)/1.1f;
            //          blob1.color[1]=(blob1.color[1]+blob2.color[1]*0.1f)/1.1f;
            //          blob1.color[2]=(blob1.color[2]+blob2.color[2]+0.1f)/1.1f;
            //blob2.v=random(1,5)*findSign(blob2.v)*-1;
            //
            //          for (int i=(blob1.x-1); i<=(blob1.x+1); i++){
            //            strip.setPixelColor(i,brightness*(blob1.color[0]+blob2.color[0])/2,brightness*(blob1.color[1]+blob2.color[1])/2,brightness*(blob1.color[2]+blob2.color[2])/2);
            //          }
            //          for (int i=(blob2.x-1); i<=(blob2.x+1); i++){
            //            strip.setPixelColor(i,brightness*(blob1.color[0]+blob2.color[0])/2,brightness*(blob1.color[1]+blob2.color[1])/2,brightness*(blob1.color[2]+blob2.color[2])/2);
            //          }
            //          strip.show();
            //          delay(10);
